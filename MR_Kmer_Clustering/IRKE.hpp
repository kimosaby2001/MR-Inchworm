...
public:
    ...
    unsigned int compute_sequence_assemblies(unsigned long long zone,
				     ofstream &outFile,
				     float min_connectivity = 0.2, 
...
private:
    ...
    unsigned int compute_sequence_assemblies(unsigned long long zone, ofstream &outFile, KmerCounter& kcounter, float min_connectivity, 
